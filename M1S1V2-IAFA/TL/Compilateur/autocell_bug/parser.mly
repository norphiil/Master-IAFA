...
|	ID ASSIGN expression WHEN condition COMMA when_statement
		{
			if get_var($1) != -1 then
				SET_VAR(get_var($1), IF_THEN($5, $3, $7))
			else
				SET_VAR(declare_var($1), IF_THEN($5, $3, $7));
		}
;
...
when_statement:
	expression OTHERWISE
		{ $1 }
|	expression WHEN condition COMMA when_statement
		{
			IF_THEN($3, $1, $5)
		}
;
